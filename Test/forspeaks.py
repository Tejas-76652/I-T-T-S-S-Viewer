...
# Each Speak button Fuctionality:
...
Speak1 = tk.Button(root, text="Speakup",command=Uploadspeak)
...
Speak2 = tk.Button(root, text="Speaktrans",command=Translatespeak)
...
#speakicon3 = PhotoImage(file="assets/Speakericon.png")
Speak3 = tk.Button(root, text="SpeakSumm",command=Summaryspeak)
...
#              width=130, font="arial 14 bold",command=translate)
